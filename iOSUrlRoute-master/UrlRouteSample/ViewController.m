...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
        {
            [[SDCUrlRouteCenter sharedCenter]open:localRouteUrl(@"TestViewController") animated:YES];
        }
            break;
        case 1:
        {
            [[SDCUrlRouteCenter sharedCenter] open:@"campuslocal://TestViewController" animated:YES];
        }
            break;
        case 2:
        {
